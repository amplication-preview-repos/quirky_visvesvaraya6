...
class JobVacancyUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ApplicationUpdateManyWithoutJobVacanciesInput,
  })
  @ValidateNested()
  @Type(() => ApplicationUpdateManyWithoutJobVacanciesInput)
  @IsOptional()
  @Field(() => ApplicationUpdateManyWithoutJobVacanciesInput, {
    nullable: true,
  })
...
export { JobVacancyUpdateInput as JobVacancyUpdateInput };
