...
@InputType()
class ApplicationUpdateManyWithoutJobVacanciesInput {
...
export { ApplicationUpdateManyWithoutJobVacanciesInput as ApplicationUpdateManyWithoutJobVacanciesInput };
